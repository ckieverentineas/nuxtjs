...
<template>
  <div>
    ...
    <div class="states">
      ...
      <img title="Ваш профиль" src="https://moblegends.ru/wp-content/uploads/2020/03/faramis-1.png"></img>
      <div class="fon">
      ...
      <img title="Ваш враг" src="https://avatars.mds.yandex.net/get-zen_doc/1628837/pub_5ea02b10fd59420be5ff909e_5ea02ba2f5567254fc35298a/scale_2400"></img>
      <div class="fon">
        <p>{{mob}}</p>
      </div>
    </div>
